...
SRC = $(SRCDIR)/Modules.f90 $(SRCDIR)/Solidbody.f90 $(SRCDIR)/LatticeBoltzmannSolver.f90 $(SRCDIR)/PostProcessing.f90 $(SRCDIR)/StructureSolver.f90 $(SRCDIR)/Initialization.f90  $(SRCDIR)/Interaction.f90 $(SRCDIR)/main.f90  $(SRCDIR)/Util.f90
