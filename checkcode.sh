...
cat src/ConstParams.f90 src/FlowCondition.f90 src/SolidSolver.f90  src/Solidbody.f90  src/FluidDomain.f90  src/LBMBlockComm.f90  src/Util.f90  src/main.f90  > combineforcheck.f90
