...
!    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    SUBROUTINE cptForceR(nFish,dxmin,dymin,dzmin,nND,nND_max,xyzful,repful)
...
!   ===============================================================================================
    ...
    real(8):: weightm,forceElem(nEL,3),forceNode(nND,3)
...
!
        if    (nELt == 2) then
!            frame
            forceElem(iEL,1:3)=[0.0d0,0.0d0,0.0d0]
        elseif (nELt == 3) then
!           plate
            x1=xyzful(i,1)
            x2=xyzful(j,1)
...
!            determine vector area         
            ax(1) =((z1-z2)*(y3-y2) + (y2-y1)*(z3-z2))/2.0d0
            ay(1) =((x1-x2)*(z3-z2) + (z2-z1)*(x3-x2))/2.0d0
            az(1) =((y1-y2)*(x3-x2) + (x2-x1)*(y3-y2))/2.0d0
