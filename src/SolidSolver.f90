module SolidSolver
  ...
  contains
    ...
    if(m_iKB==0)then
        ...
        enddo
        this%KB=sum(this%prop(1:this%nEL,1)*this%prop(1:this%nEL,6))/(denIn*Uref**2*Lref**3)/this%nEL**2
        this%KS=sum(this%prop(1:this%nEL,1)*this%prop(1:this%nEL,3))/(denIn*Uref**2*Lref)/this%nEL**2
    endif
    ...
    if(m_iKB==1)then
        ...
        enddo
        this%EmR = sum(this%prop(1:this%nEL,1))/(denIn*Uref**2)/this%nEL
        this%tcR = sum(this%prop(1:this%nEL,3))/Lref/this%nEL
        nLthck=sum(this%prop(1:this%nEL,3))/this%nEL
    endif
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    real(8):: vBC(nND,6),xyzful0(nND,6),xyzful(nND,6),prop(nEL,10)
